...
public class Reservoir {
     ...
     * @param key      the key string.
     * @param object   the object to be stored.
     * @param callback a callback of type {@link ...}
     ...
     *
     * @param key      the key string.
     * @param callback a callback of type {@link com.jci.vsd.utils.reservoir.ReservoirDeleteCallback}
     *                 which is called upon completion.
     * @throws IllegalStateException thrown if init method hasn't been called.
     */
     ...
     *
     * @param callback a callback of type {@link com.jci.vsd.utils.reservoir.ReservoirClearCallback}
     *                 which is called upon completion.
     * @throws IllegalStateException thrown if init method hasn't been called.
     */
